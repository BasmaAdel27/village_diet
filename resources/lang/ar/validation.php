...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'country_id' => 'الدولة',
        'insta_link' => 'رابط الانستجرام',
        'join_request_reason' => 'سبب طلب الانضمام',
        'bio' => 'النبذة التعريفية',
        'cv' => 'السيرة الذاتية',
        'current_job' => 'الوظيفة الحالية',

        'q2' => 'ماذا تريد أن تحقق خلال ال4 أسابيع القادمة ؟',
        'q4' => 'مستوي التوتر و الضغط اليومي',
        'q14' => 'الحالة الاجتماعية',
        'q16' => 'هل لديك الأطفال ؟',
        'q18' => 'الجنس',
        'q19' => 'هل تمارس الرياضة',
        'q21' => 'ما هي الأدوات الرياضية المتوفرة لديك ؟',
        'q23' => 'هل أنت مدخن ؟',
        'q25' => 'مستوي النشاط اليومي',
        'q28' => 'كم مرة تأكل خارج المنزل ؟',
        'q30' => 'هل تستمتع بتناول الافطار مبكرا ؟',
        'q32' => 'هل لديك حساسية من بعض الأطعمة؟',

        'q9' => 'متوسط عدد ساعات النوم',
        'q10' => 'الوزن الحالي',
        'q11' => 'الطول',
        'q12' => 'المهنة',
        'q34' => 'الأطعمة المسببة للحساسية',
        'q36' => 'أنواع الطعام المفضلة لديك',
        'q37' => 'أعلي الذراع في المنتصف بين الكوع و الكتف (سم)',
        'q38' => 'قياس الوسط 5 سم أسفل الصرة (سم)',
        'q39' => 'قياس الوسط 5 سم فوق الصرة (سم)',
        'q40' => 'قياس الوسط عند الصرة (سم)',
        'q41' => 'أعلي الساق في المنتصف بين الركبة و الورك (سم)',
    ],
