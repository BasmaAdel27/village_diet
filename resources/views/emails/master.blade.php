    ...
    <tr>
      <td align="center" valign="top" id="bodyCell">
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" width="100%"
                                  ...
                                  <tr>
                                    <td align="left" class="textContent">
                                      {{-- <div
                                        style="font-family:Helvetica,Arial,sans-serif;font-size:13px;color:#9281f1;text-align:center;line-height:120%;">
                                        If you have any troubles, you can see this email <a
                                          href="http://www.script-tutorials.com/responsive-html-email-template/"
                                          target="_blank"
                                          style="text-decoration:none;border-bottom:1px solid #9281f1;color:#9281f1;"><span
                                            style="color:#9281f1;">in your browser</span></a>.
                                      </div> --}}
                                    </td>
                                  </tr>
                                </table>
        ...
        <table bgcolor="#FFFFFF" border="0" cellpadding="0" cellspacing="0" width="500" id="emailBody">
          ...
          <tr>
            <td align="center" valign="top">
              <table border="0" cellpadding="0" cellspacing="0" width="100%" style="color:#FFFFFF;" bgcolor="grey">
                <tr>
                  <td align="center" valign="top">
                            ...
                            <tr>
                              <td align="center" valign="top" class="textContent">
                                <h1
                                  ...
                                  {{ app()->getLocale() == 'en' ? "Village Diet" : "فيلج دايت"}}
                                </h1>
                                <h2
