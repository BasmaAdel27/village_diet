          ...
          <div class="contain">
            ...
            <div class="tab-content" id="myTabContent">
              <div class="tab-pane fade show active" id="tab-1" role="tabpanel" aria-labelledby="tab-1-tab">
                ...
                <form action="{{ route('website.register.store') }}" class="form-contain" method="POST"
                      id="registerForm">
                  @csrf
                  <h2 class="sub-title">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-6 col-12 px-2">
                      <div class="form-group">
                        <img src="{{ asset('website/assets/images/form/sms.svg') }}" class="icon" loading="lazy"
                             alt=""/>
                      ...
                      <div class="form-group select">
                        ...
                        <select class="form-control" name="country_id" id="country">
                          ...
                          @foreach ($countries as $id => $name)
                            <option
                                  value="{{ $id }}" {{ $id==old('country_id') ? 'selected' : '' }}>{{ $name }}</option>
                          @endforeach
                        </select>
                      </div>
                    </div>
