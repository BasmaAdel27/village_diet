<a href="{{ route('admin.users.show',[$query->user_id,'subscription_id' => $query->id]) }}"
  class="btn btn-outline-success mr-2 p-2">@lang('user_details')</a>
...
@endcan
<form action="{{ route('admin.subscriptions.active',$query->id) }}" style="display:inline-block" id="ActiveForm"
