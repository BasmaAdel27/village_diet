          ...
          <div class="form-group col-6">
            ...
            <div class="form-group col-6">
              ...
              <select name="body_shape" class="form-control" name="body_shape">
                ...
                <option value="Stretchy muscles" >@lang('Stretchy muscles')</option>
                <option value="Medium build" >@lang('Medium build')</option>
                <option value="Slightly overweight" >@lang('Slightly overweight')</option>
