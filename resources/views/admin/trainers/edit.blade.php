          ...
          <div class="row">
            ...
            <div class="form-group col-6">
              ...
              <select name="body_shape" class="form-control" name="body_shape">
                ...
                <option value="Stretchy muscles" {{'Stretchy muscles' == $trainer->body_shape ?'selected': '' }}>@lang('Stretchy muscles')</option>
                <option value="Medium build" {{'Medium build' == $trainer->body_shape ?'selected': '' }}>@lang('Medium build')</option>
                <option value="Slightly overweight" {{'Slightly overweight' == $trainer->body_shape ?'selected': '' }} >@lang('Slightly overweight')</option>
                <option value="overweight"  {{'overweight' == $trainer->body_shape ?'selected': '' }}>@lang('overweight')</option>
              </select>
            </div>
            <div class="form-group col-6">
