    ...
    <div class="chat-message clearfix">
      <div class="input-group mb-0">
        <div class="input-group-prepend">
             <button type="submit" class="btn btn-primary" name="submit" style="margin-right: 2px"><i class="mdi mdi-send"></i> </button>
          ...
          <div class="modal-content">
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-danger" data-dismiss="modal">@lang('close')</button>
                ...
                <button type="submit" class="btn btn-success" id="downloadButton" data-dismiss="modal" disabled>@lang('send')</button>
            </div>
