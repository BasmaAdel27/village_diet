...
class SendTrainerNewMessage extends Notification
{
    ...
    {
        $message_ar = $this->trainerMessage?->sender->full_name . ' تم استقبال رسالة جديدة من ';
        $message_en = $this->trainerMessage?->sender->full_name . ' had sent you a message';
        return [
              'id' => $this->trainerMessage->id,
              'type' => 'trainer_chat',
              'title' => trans('mobile.notifications.content.trainer_new_message', locale: 'en'),
              'title_ar' => trans('mobile.notifications.content.trainer_new_message', locale: 'ar'),
