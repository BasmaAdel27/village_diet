...
class HomeController extends Controller
{
    public function index()
    {
        ...
        $ourVisionPage = StaticPage::where('is_active', true)->where('programing_name', 'About-Village-Diet')->first();
        $aboutPage = StaticPage::where('is_active', true)->where('programing_name', 'Our-Vision')->first();
